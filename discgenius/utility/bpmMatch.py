...
def adjust_tempo(config, song_name, song_tempo, song_tempo_new):
    ...
    print("INFO - Creating adjusted tempo copy of song "+song_name+" ("+str(song_tempo)+") with new tempo "+str(song_tempo_new))
